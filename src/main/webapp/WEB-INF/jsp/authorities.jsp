	...
	<table class="table" style="width: 900;">
		...
		<c:forEach items="${authorities}" var="authorities" varStatus="status">
			<tr > 
				...
				<td> <button type="button" class="btn btn-success"><i class="fa fa-refresh"></i><a href="http://localhost:8080/authorities/update/${authorities.username}" style="text-decoration: none; color: black"> Update</a> </button></td>
				</sec:authorize> 
				<sec:authorize access="hasRole('ROLE_ADMIN')">
<td> <button type="button" class="btn btn-danger"><i class="fa fa-trash"></i><a href="http://localhost:8080/authorities/delete/${authorities.username}" style="text-decoration: none; color: black"> Delete</a> </button></td>	
				</sec:authorize>	
			</tr>
	...
	<sec:authorize access="hasRole('ROLE_ADMIN')">
	<button type="button" class="btn btn-secondary"><i class="fa fa-plus"></i><a href="http://localhost:8080/authorities/new" style="text-decoration: none; color: black"> Create</a></button> 
	</sec:authorize>
	<sec:authorize access="hasRole('ROLE_ADMIN')">
	<button type="button" class="btn btn-secondary"><a href="http://localhost:8080/users" style="text-decoration: none; color: black"> Users</a></button> 
	</sec:authorize>
